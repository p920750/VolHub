                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              ...
                              if (!_isLogin) {
                                ...
                                final hasRequiredSpecial = value.contains('#') || value.contains('@') || value.contains('_');
                          ...
                          _SocialButton(
                            ...
                            onPressed: () async {
                              try {
                                // If a user is already logged in, sign them out first
                                // so they can choose a different Google account.
                                if (SupabaseService.isLoggedIn) {
                                  await SupabaseService.signOut();
                                }

                                await SupabaseService.signInWithGoogle();
                                // The OAuth flow will redirect, so we don't need to show loading here
                          ...
                          _SocialButton(
                            ...
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Facebook authentication coming soon!'),
                                ),
                              );
                            },
                          ),
