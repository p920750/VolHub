...
class HostService {
    ...
    try {
      ...
      return filteredResponse.map((e) {
        ...
        return {
          ...
          'image_url': e['image_url'] ?? 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800',
  ...
  static Future<List<Map<String, dynamic>>> getRecommendedManagers() async {
