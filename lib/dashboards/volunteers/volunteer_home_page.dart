...
import 'volunteer_leaderboard_page.dart';
...
class _VolunteerHomePageState extends State<VolunteerHomePage> {
  ...
  bool _hasCheckedInitialIndex = false;

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    if (!_hasCheckedInitialIndex) {
                ...
                children: [
                  ...
                  _buildSectionCard([
                    _buildMenuItem(
                      ...
                      title: 'See Recommended Events',
                      onTap: () => Navigator.pushNamed(context, '/volunteer-recommendations'),
                    ),
                    _buildMenuItem(
                      icon: Icons.logout, 
                      title: 'Sign Out',
